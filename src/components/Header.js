    ...
    if(localStorage.getItem('name')==null)
    {
        return(
            ...
            <div className="container-fluid">
                ...
                <a className="navbar-brand ms-5" href='/#' onClick={()=>{changeUrl('/')}}><img src={ICONS + "profile1.png"} alt={"dd"} style={{ width: "40px", height: "40px", marginRight: "15px" }} /> Bandai.Com</a>
                <div className="collapse navbar-collapse" id="navbarTogglerDemo03">
                    <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                        
                        {/* <li className="nav-item">
                            <a className="nav-link" href="/#" onClick={()=>changeUrl('/')} style={{ padding: "2px 0 0 0" }}><img src={ICONS + "user02.png"} alt={"dd"} style={{ width: "40px", height: "40px" }} /></a>
                        </li> */}
                    </ul>
